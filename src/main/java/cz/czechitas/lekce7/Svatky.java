...
public class Svatky {
    ...
    public MonthDay vratKdyMaSvatek(String jmeno) {
      return svatky.getOrDefault(jmeno, null);
    }
    ...
    public void pridejSvatek(String jmeno, MonthDay denMesic) {
        svatky.put(jmeno, MonthDay.of(denMesic.getMonth(), denMesic.getDayOfMonth()));
    }
    ...
    public void pridejSvatek(String jmeno, int den, Month mesic) {
        svatky.put(jmeno, MonthDay.of(mesic.getValue(), den)); //vzalo by i typ Month
    }
